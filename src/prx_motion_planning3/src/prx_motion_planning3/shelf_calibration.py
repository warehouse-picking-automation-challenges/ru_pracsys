...
def motion_planner_main():
    ...
    # poseDW = Pose()
    # poseDW.position.x = 0.8
    # poseDW.position.y = 0.43
    # poseDW.position.z = 0.65
    # poseDW.orientation.x = .5
    # poseDW.orientation.y = -.5
    # poseDW.orientation.z = -.5
    # poseDW.orientation.w = .5
    # print "\n\nGoing to DW: " , poseDW
    # plan_and_move_end_effector_to("",poseDW,speed,0)

    # poseDE = copy.deepcopy(poseDW)
    # poseDE.position.x = 0.8
    # poseDE.position.y = -0.43
    # poseDE.position.z = 0.65
    # plan_and_move_end_effector_to("",poseDE,speed,0)

    # poseUW = copy.deepcopy(poseDW)
    # poseUW.position.x = 0.8
    # poseUW.position.y = 0.43
    # poseUW.position.z = 1.65
    # print "\n\nGoing to DW: " , poseUW
    # plan_and_move_end_effector_to("",poseUW,speed,0)

    # poseUE = copy.deepcopy(poseDW)
    # poseUE.position.x = 0.8
    # poseUE.position.y = -0.43
    # poseUE.position.z = 1.65
    # print "\n\nGoing to DW: " , poseUE
    # plan_and_move_end_effector_to("",poseUE,speed,0)
    ...
    for hand in "arm_right","arm_left":
        ...
        for bin in 'A','B','C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L':
        # for bin in 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L':
        # for bin in 'J', 'K', 'L':           
            print "\n\nGoing to map position ",bin
            plan_and_move_end_effector_to("",g_bin_positions[1][1][bin]['map_robot_position_1'],speed,0)
            print "\n\nGoing to grasp position ",bin
            # remove_shelf_from_the_scene()
            plan_and_move_end_effector_to("",g_bin_positions[1][1][bin]['grasp_pose'],speed,0)
            print "\n\nGoing to map position ",bin
            plan_and_move_end_effector_to("",g_bin_positions[1][1][bin]['map_robot_position_1'],speed,0)
            # print "\n\nGoing to home position ",bin
            # add_shelf_to_scene()
            # plan_and_move_to_joints_configuration(g_to_origin_robot_position,speed)
        plan_and_move_to_joints_configuration(g_to_origin_robot_position,speed)
        return

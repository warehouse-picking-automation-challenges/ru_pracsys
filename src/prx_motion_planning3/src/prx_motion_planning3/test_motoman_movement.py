...
def compute_scene_poses():
    ...
    for robot in 0, 1: # 0 = BAXTER, 1 = MOTOMAN
        ...
        if robot == BAXTER:
            ...
            x_origin = g_shelf_description.x - 0.15
            x_mapping = g_shelf_description.x - 0.3
            ...
            for arm in 0, 1: # 0 = left, 1 = right
                ...
                for bin in 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L':
                    ...
                    # pose.orientation.y = math.sqrt(.5)
...
def motion_planner_main():
    ...
    g_to_origin_robot_position = {'arm_left_joint_1_s': 1.57,'arm_left_joint_2_l': 0,'arm_left_joint_3_e': 0,'arm_left_joint_4_u': -1.70,'arm_left_joint_5_r': 0,'arm_left_joint_6_b': 0,'arm_left_joint_7_t': 0,'arm_right_joint_1_s': 1.57,'arm_right_joint_2_l': 0,'arm_right_joint_3_e': 0,'arm_right_joint_4_u': -1.70,'arm_right_joint_5_r': 0,'arm_right_joint_6_b': 0,'arm_right_joint_7_t': 0,'torso_joint_b1':0}
    ...
    for hand in "arm_left","arm_right":

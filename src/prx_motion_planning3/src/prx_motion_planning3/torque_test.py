...
def get_object_pose():
    ...
    if HARD_CODED_OBJECT == True:
        ...
        if g_robot == BAXTER:
            ...
            object_pose.position.x = 1.08814692051 #trans[0]
            object_pose.position.y = 0.241470124204 #trans[1]
            object_pose.position.z = 1.00762490735 #trans[2]
            object_pose.orientation.x = -0.477072525368 #rot[0]
            object_pose.orientation.y = 0.534384847975 #rot[1]
            object_pose.orientation.z = -0.488505960788 #rot[2]
            object_pose.orientation.w = 0.498193301911 #rot[3]
...
def motion_planner_main():
    ...
    print g_bin_positions[1][0]['A']['bin_robot_position']

    # g_to_origin_robot_position = {'arm_left_joint_1_s': 1.57,'arm_left_joint_2_l': 0,'arm_left_joint_3_e': 0,'arm_left_joint_4_u': -2.09,'arm_left_joint_5_r': 0,'arm_left_joint_6_b': 0,'arm_left_joint_7_t': 0,'arm_right_joint_1_s': 1.57,'arm_right_joint_2_l': 0,'arm_right_joint_3_e': 0,'arm_right_joint_4_u': -2.09,'arm_right_joint_5_r': 0,'arm_right_joint_6_b': 0,'arm_right_joint_7_t': 0,'torso_joint_b1':0}
    # g_to_order_bin_robot_position = {'arm_left_joint_1_s': 1.396,'arm_left_joint_2_l': 1.57,'arm_left_joint_3_e': 0,'arm_left_joint_4_u': 0.1745,'arm_left_joint_5_r': 0,'arm_left_joint_6_b': 0,'arm_left_joint_7_t': 0,'arm_right_joint_1_s': 1.396,'arm_right_joint_2_l': 1.57,'arm_right_joint_3_e': 0,'arm_right_joint_4_u': 0.1745,'arm_right_joint_5_r': 0,'arm_right_joint_6_b': 0,'arm_right_joint_7_t': 0,'torso_joint_b1':0}


    g_to_origin_robot_position = {'arm_left_joint_1_s': 1.57,'arm_left_joint_2_l': 0,'arm_left_joint_3_e': 0,'arm_left_joint_4_u': -2.09,'arm_left_joint_5_r': 0,'arm_left_joint_6_b': 0,'arm_left_joint_7_t': 0,'arm_right_joint_1_s': 0,'arm_right_joint_2_l': -.6,'arm_right_joint_3_e': 0,'arm_right_joint_4_u': .8,'arm_right_joint_5_r': 0,'arm_right_joint_6_b': 0,'arm_right_joint_7_t': 0,'torso_joint_b1':0}
    g_to_order_bin_robot_position = {'arm_left_joint_1_s': 1.57,'arm_left_joint_2_l': 0,'arm_left_joint_3_e': 0,'arm_left_joint_4_u': -2.09,'arm_left_joint_5_r': 0,'arm_left_joint_6_b': 0,'arm_left_joint_7_t': 0,'arm_right_joint_1_s': 0,'arm_right_joint_2_l': .6,'arm_right_joint_3_e': 0,'arm_right_joint_4_u': -.8,'arm_right_joint_5_r': 0,'arm_right_joint_6_b': 0,'arm_right_joint_7_t': 0,'torso_joint_b1':0}

    # add_order_bin_to_scene()
    # add_shelf_to_scene()
    while True:
        init_planning_library("arm_right","moto")
        plan_and_move_to_joints_configuration(g_to_origin_robot_position,2)
        init_planning_library("arm_right","moto")
        plan_and_move_to_joints_configuration(g_to_order_bin_robot_position,2)

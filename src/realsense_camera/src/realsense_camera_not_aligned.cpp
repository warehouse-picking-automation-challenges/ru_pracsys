...
unsigned char *rgb_640_480_frame_buffer = NULL;
...
processRGBD()
{
  ...
  Mat rgb_640_480_frame(480, 640, CV_8UC3, rgb_640_480_frame_buffer);
	//YUV 2 RGB
...
int main(int argc, char* argv[])
{
    ...
    rgb_640_480_frame_buffer = new unsigned char[640 * 480 * 3]

...
int initStreams(VIDEO_DEVICE& matched_realsense, std::string serial_number="")
{
  //find realsense video device
    ...
    if(1)
    {
      ...
      {
        if(serial_number=="" || video_lists[i].serial_number.c_str() == serial_number.c_str())
        {
...
int main(int argc, char* argv[])
{
    ...
    //Set up realsense ROS camera pubsub
      ...
      ros::NodeHandle rgb_nh(n, "/camera/rgb");
      image_transport::ImageTransport rgb_it(rgb_nh);
      ros::NodeHandle ir_nh(n, "/camera/ir");
      image_transport::ImageTransport ir_it(ir_nh);
      ros::NodeHandle depth_nh(n, "/camera/depth");
      image_transport::ImageTransport depth_it(depth_nh);
      ros::NodeHandle depth_registered_nh(n, "/camera/depth_registered");
      ...
      ros::NodeHandle recon_nh(n, "/camera/driver");

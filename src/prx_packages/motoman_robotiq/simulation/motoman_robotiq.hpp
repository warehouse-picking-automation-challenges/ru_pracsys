...
#ifndef PRX_MOTOMAN_ROBOTIQ_PLANT_HPP
#define	PRX_MOTOMAN_ROBOTIQ_PLANT_HPP
...
namespace prx
{
    namespace packages
    {
        namespace motoman_robotiq
        {
             ...
             * 
             */
            class motoman_robotiq_plant_t : public baxter::manipulator_plant_t
            {

              public:
                motoman_robotiq_plant_t();

                virtual ~motoman_robotiq_plant_t(){ }

...
#ifndef PRX_MOTOMAN_PLANT_HPP
#define	PRX_MOTOMAN_PLANT_HPP
...
namespace prx
{
    namespace packages
    {
        namespace motoman
        {
             ...
             * 
             */
            class motoman_plant_t : public baxter::manipulator_plant_t
            {

              public:
                motoman_plant_t();

                virtual ~motoman_plant_t(){ }
              ...
              protected:
                ...
                std::string simple_ee_name;
                std::string simple_camera_name;
                ...
                std::vector<RigidBodyDynamics::Math::VectorNd> config_offsets;

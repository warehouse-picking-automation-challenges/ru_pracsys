...
namespace prx
{
    namespace packages
    {
        namespace sparse_rrt
        {
             ...
             */
            class sparse_rrt_t : public plan::rrt_t
            {
                public:
                    sparse_rrt_t();
                    virtual ~sparse_rrt_t();
                ...
                protected:   
                     ...
                     */
                    sparse_rrt_node_t* get_vertex(util::tree_vertex_index_t v) const;
                     ...
                     */
                    sparse_rrt_edge_t* get_edge(util::tree_edge_index_t e) const;

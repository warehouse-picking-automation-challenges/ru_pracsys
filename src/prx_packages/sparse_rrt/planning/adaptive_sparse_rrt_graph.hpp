...
#ifndef PRX_ADAPTIVE_SPARSE_RRT_GRAPH_HPP
#define	PRX_ADAPTIVE_SPARSE_RRT_GRAPH_HPP
...
namespace prx
{
    namespace packages
    {
        namespace sparse_rrt
        {
             ...
             */
            class adaptive_sparse_rrt_node_t : public plan::rrt_node_t
            {
                public:
                    adaptive_sparse_rrt_node_t() : plan::rrt_node_t()
                    {
                        bridge = false;
                    }
                    /**
            ...
            class adaptive_sparse_rrt_edge_t : public plan::rrt_edge_t
            {
            };
